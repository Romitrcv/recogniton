...
cen_h2_x=cen_h2_y=cen_h1_x=cen_h1_y=cen_face_x=cen_face_y=righthand_y=righthand_x=lefthand_x=lefthand_y=0
...
#search face and put a rectangle of blue colour on face
 ...
 # show the images 
    if(cen_h2_x <cen_face_x):
        righthand_x = cen_h2_x
        lefthand_x = cen_h1_x
        righthand_y = cen_h2_y
        lefthand_y = cen_h1_y
    elif(cen_h1_x < cen_face_x):
        righthand_x = cen_h1_x
        lefthand_x = cen_h2_x
        righthand_y = cen_h1_y
        lefthand_y = cen_h2_y
    if((righthand_y + 10) < cen_face_y and (lefthand_y + 10) < cen_face_y):
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(image,"both hands up",(30,30), font, 0.5,(255,255,255),2,cv2.LINE_AA)
        print "both hands up"
    elif((righthand_y + 10) < cen_face_y):
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(image,"right hand up",(30,30), font, 0.5,(255,255,255),2,cv2.LINE_AA)
        print "right hand up"
    elif((lefthand_y + 10) < cen_face_y):
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(image,"left hand up",(50,50), font, 0.5,(255,255,255),2,cv2.LINE_AA)
        print "left hand up"
    elif((righthand_y - 200) > cen_face_y and (lefthand_y - 200) > cen_face_y):
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(image,"both hands down",(30,30), font, 0.5,(255,255,255),2,cv2.LINE_AA)
        print "both hands down"
    elif((righthand_y - 200) > cen_face_y):
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(image,"right hand down",(30,30), font, 0.5,(255,255,255),2,cv2.LINE_AA)
        print "right hand down"
    elif((lefthand_y - 200) > cen_face_y):
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(image,"left hand down",(50,50), font, 0.5,(255,255,255),2,cv2.LINE_AA)
